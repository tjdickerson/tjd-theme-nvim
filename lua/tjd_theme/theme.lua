...
theme.set_highlights = function()
	...
	hl(0, "MatchParen", { fg = c.white, bg = c.yellow })
	...
	hl(0, "Search", { fg = c.green, bg = c.black })
	hl(0, "IncSearch", { fg = c.yellow, bg = c.bg })
	...
	-- Bash
	hl(0, "@variable.parameter.bash", { fg = c.red, bg = "NONE" })
	...
	-- C
	hl(0, "@variable.parameter.c", { fg = c.red, bg = "NONE" })
	...
	-- Lua
	hl(0, "@lsp.type.parameter.lua", { fg = c.orange, bg = "NONE" })
	hl(0, "@variable.parameter.lua", { fg = c.orange, bg = "NONE" })
